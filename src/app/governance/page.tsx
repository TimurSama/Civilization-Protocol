...
export default function GovernancePage() {
    ...
    const proposals: Proposal[] = [
        ...
        },
        {
            ...
            descEn: "Integration of Regen Network carbon credit system into VODeco ecosystem.",
            descAr: "دمج نظام أرصدة الكربون Regen Network في نظام VODeco البيئي.",
            status: "passed",
            votesFor: 750000,
            votesAgainst: 22000,
            abstain: 8000,
                        ...
                        >
                            ...
                            <div className="space-y-3 mb-6">
                                {[
                                    ...
                                    <button
                                        key={option.id}
                                        onClick={() => setVoteChoice(option.id as any)}
                                        className={cn(
